...
hidden if the `repo1_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `repo1_DEVELOPER_MODE` to the configure
...
Runs the executable target `repo1_exe`.
